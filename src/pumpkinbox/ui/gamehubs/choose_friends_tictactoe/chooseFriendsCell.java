    ...
    protected void updateItem(EditFriendObject editFriendObject, boolean empty) {
        ...
        if(empty || editFriendObject == null) {
            ...
            root.setOnMouseClicked(event -> {
                ...
                int friend_id = editFriendObject.getFriend_id();
                MessageObject x = new MessageObject(editFriendObject.getSenderId(), friend_id, "tictactoe");
                ...
                if(r.getResponse().equals(CODES.OK)){
                    ...
                    Thread y = new Thread(() -> {
                        ...
                        while (true) {
                            try {
                                TicTacToeClient client = new TicTacToeClient(false, false);
                                client.setSender_id(editFriendObject.getSenderId());
                                client.setReceiver_id(friend_id);
